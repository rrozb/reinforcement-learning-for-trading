...
class TradingMultiAssetEnv(gym.Env):
    metadata = {'render_modes': ['logs']}
    ...
    def __init__(self,
        ...
        if not isinstance(df.index, pd.MultiIndex):
            raise ValueError("The provided dataframe should have a multi-index with asset names and dates.")

        # attributes that initialized in reset:
        self._step = None
        self._position = None
